...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonicalUrl = `${brandCanonicalOrigin}/search`;

  return {
    title: `Search Movies & Shows | ${brandName}`,
    description: `Search full catalogue of HD movies and TV shows instantly on ${brandName}.`,
    alternates: {
