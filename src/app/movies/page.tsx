...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonicalUrl = `${brandCanonicalOrigin}/movies`;

  return {
    title: `Watch Free Movies Online in HD | ${brandName}`,
    description: `Stream thousands of trending movies online in full HD for free on ${brandName}.`,
    alternates: {
