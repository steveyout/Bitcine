...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const canonicalUrl = `${brandCanonicalOrigin}/dmca`;

  return {
    title: `DMCA Copyright Policy | ${brandName}`,
    description: `DMCA policy and copyright information for ${brandName}. We respect intellectual property rights.`,
    alternates: {
